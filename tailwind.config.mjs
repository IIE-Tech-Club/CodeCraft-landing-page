  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'navbar': '0 18px 48px rgba(0, 0, 0, 0.45), inset 0 1px 0 rgba(255, 255, 255, 0.06)',
      ...
      backgroundImage: {
        'gradient-neon': 'linear-gradient(135deg, #12e6ff 0%, #37b0ff 50%, #12e6ff 100%)',
      ...
      animation: {
        ...
        'loader-entry': 'loader-entry 0.8s cubic-bezier(0.2, 0.7, 0.2, 1) 0.1s forwards',
